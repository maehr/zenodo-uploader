...
- **9 volumes** — one record per volume DOI (`10.21255/sgb-0X-…`) with the official full-volume PDF.
...
#    Without --source, the chapter/volume PDFs and HTML are downloaded from
#    emono/GitHub; each volume always uses its official full-volume PDF.
