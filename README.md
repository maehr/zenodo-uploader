...
uv run zenodo-uploader from-doi 10.21255/sgb-03.05-238056 --dry-run

# Create a draft on the sandbox with a file attached
uv run zenodo-uploader from-doi 10.21255/sgb-03.05-238056 \
...
uv run zenodo-uploader from-doi 10.21255/sgb-03.05-238056 --file chapter.pdf --publish

# Check whether a DOI is already mirrored
uv run zenodo-uploader check 10.21255/sgb-03.05-238056
...
[
  {
    ...
    "files": ["files/sgb-03.05-238056.pdf", "files/sgb-03.05-238056.html"],
    "community": "stadt-geschichte-basel",
    "description": "<p>Optional HTML description override.</p>",
    "related": [{ "relation": "isPartOf", "identifier": "10.21255/sgb-03-345800" }]
  }
]
```
...
## Example: Stadt.Geschichte.Basel

[`examples/stadt-geschichte-basel/`](examples/stadt-geschichte-basel/) mirrors all 88 DOIs (9 volumes + 79 chapters) of the Stadt.Geschichte.Basel book series, including downloading the chapter PDFs and minimal-HTML editions from emono.unibas.ch and merging per-volume PDF bundles.
